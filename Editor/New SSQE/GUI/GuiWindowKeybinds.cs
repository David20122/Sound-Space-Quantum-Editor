...
namespace New_SSQE.GUI
{
    internal class GuiWindowKeybinds : GuiWindow
    {
        ...
        private readonly GuiLabel HFlipLabel = new(1366, 520, 128, 26, "Horizontal Flip", 28, "main", false);
        private readonly GuiLabel HFlipCAS = new(1642, 550, 256, 40, "", 28, "main", false);
        private readonly GuiTextbox HFlipBox = new(1366, 550, 128, 40, 28, "hFlip");
        private readonly GuiButton HFlipReset = new(1504, 550, 128, 40, 1, "RESET", 28);

        private readonly GuiLabel VFlipLabel = new(1366, 600, 128, 26, "Vertical Flip", 28, "main", false);
        private readonly GuiLabel VFlipCAS = new(1642, 630, 256, 40, "", 28, "main", false);
        private readonly GuiTextbox VFlipBox = new(1366, 630, 128, 40, 28, "vFlip");
        private readonly GuiButton VFlipReset = new(1504, 630, 128, 40, 2, "RESET", 28);

        private readonly GuiLabel StoreNodesLabel = new(1366, 680, 128, 26, "Store Bezier Nodes", 28, "main", false);
        private readonly GuiLabel StoreNodesCAS = new(1642, 710, 256, 40, "", 28, "main", false);
        private readonly GuiTextbox StoreNodesBox = new(1366, 710, 128, 40, 28, "storeNodes");
        private readonly GuiButton StoreNodesReset = new(1504, 710, 128, 40, 7, "RESET", 28);

        private readonly GuiLabel AnchorNodeLabel = new(1366, 760, 128, 26, "Anchor Bezier Node", 28, "main", false);
        private readonly GuiLabel AnchorNodeCAS = new(1642, 790, 256, 40, "", 28, "main", false);
        private readonly GuiTextbox AnchorNodeBox = new(1366, 790, 128, 40, 28, "anchorNode");
        private readonly GuiButton AnchorNodeReset = new(1504, 790, 128, 40, 9, "RESET", 28);

        private readonly GuiLabel DrawBezierLabel = new(1366, 840, 128, 26, "Draw Bezier Curve", 28, "main", false);
        private readonly GuiLabel DrawBezierCAS = new(1642, 870, 256, 40, "", 28, "main", false);
        private readonly GuiTextbox DrawBezierBox = new(1366, 870, 128, 40, 28, "drawBezier");
        ...
        private readonly GuiTextbox SwitchClickBox = new(150, 130, 128, 40, 28, "switchClickTool");
        ...
        private readonly GuiTextbox ToggleQuantumBox = new(150, 210, 128, 40, 28, "quantum");
        ...
        private readonly GuiTextbox OpenTimingsBox = new(150, 330, 128, 40, 28, "openTimings");
        ...
        private readonly GuiTextbox OpenBookmarksBox = new(150, 410, 128, 40, 28, "openBookmarks");
        ...
        private readonly GuiTextbox OpenDirectoryBox = new(150, 490, 128, 40, 28, "openDirectory");
        ...
        private readonly GuiTextbox ExportSSPMBox = new(150, 570, 128, 40, 28, "exportSSPM");
        private readonly GuiButton ExportSSPMReset = new(288, 570, 128, 40, 11, "RESET", 28);


        private readonly GuiLabel GridLabel = new(1366, 49, 128, 26, "Grid", 28, "main", false);
        private readonly GuiTextbox GridTLBox = new(1366, 75, 128, 62, 28, "gridKey0");
        private readonly GuiButton GridTLReset = new(1366, 141, 128, 62, 90, "RESET", 36);
        private readonly GuiTextbox GridTCBox = new(1504, 75, 128, 62, 28, "gridKey1");
        private readonly GuiButton GridTCReset = new(1504, 141, 128, 62, 91, "RESET", 36);
        private readonly GuiTextbox GridTRBox = new(1642, 75, 128, 62, 28, "gridKey2");
        private readonly GuiButton GridTRReset = new(1642, 141, 128, 62, 92, "RESET", 36);
        private readonly GuiTextbox GridMLBox = new(1366, 213, 128, 62, 28, "gridKey3");
        private readonly GuiButton GridMLReset = new(1366, 279, 128, 62, 93, "RESET", 36);
        private readonly GuiTextbox GridMCBox = new(1504, 213, 128, 62, 28, "gridKey4");
        private readonly GuiButton GridMCReset = new(1504, 279, 128, 62, 94, "RESET", 36);
        private readonly GuiTextbox GridMRBox = new(1642, 213, 128, 62, 28, "gridKey5");
        private readonly GuiButton GridMRReset = new(1642, 279, 128, 62, 95, "RESET", 36);
        private readonly GuiTextbox GridBLBox = new(1366, 351, 128, 62, 28, "gridKey6");
        private readonly GuiButton GridBLReset = new(1366, 417, 128, 62, 96, "RESET", 36);
        private readonly GuiTextbox GridBCBox = new(1504, 351, 128, 62, 28, "gridKey7");
        private readonly GuiButton GridBCReset = new(1504, 417, 128, 62, 97, "RESET", 36);
        private readonly GuiTextbox GridBRBox = new(1642, 351, 128, 62, 28, "gridKey8");
